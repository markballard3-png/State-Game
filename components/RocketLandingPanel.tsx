  ...
  return (
    <div className="mt-3 rounded-2xl border border-white/15 bg-white/10 p-3">
      ...
      <div className="rocket-sky mt-3 rounded-[24px] p-4">
        <div className="relative mx-auto h-64 w-40 overflow-hidden rounded-[32px] border border-white/15 bg-gradient-to-b from-sky-300/40 via-indigo-950/70 to-emerald-500/40">
          ...
          >
            <div className="relative flex flex-col items-center">
              ...
              <div className="rocket-body text-7xl leading-none">🚀</div>
            </div>
          </div>
        ...
        <p className="mt-1 text-center text-sm leading-6 text-slate-100/90">{status}</p>
